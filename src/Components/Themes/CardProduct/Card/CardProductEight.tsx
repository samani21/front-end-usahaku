...
const CardProductEight: React.FC<ProductCardProps> = ({ product, onClick, onToggleFavorite, color }) => (
    <div
    ...
    >
        ...
        <div className="p-4 flex flex-col h-[calc(100%-10rem)]">
            ...
            <div className="mt-auto"> {/* Untuk menempatkan harga dan tombol di bawah */}
                <p className={`md:text-2xl font-black ${color?.text600} mb-4`}>Rp {product.price.toLocaleString('id-ID')}
                </p>
                <button
...
export default CardProductEight
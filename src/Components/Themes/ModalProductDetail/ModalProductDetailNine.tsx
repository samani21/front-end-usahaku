...
import { Check, CheckCircle, CheckCircleIcon, Info, Minus, PlusIcon, X, XIcon } from 'lucide-react';
...
const ModalProductDetailNine: React.FC<DetailModalProps> = ({ product, onClose, onOrder, color }) => {
...
export default ModalProductDetailNine
...
// Pastikan semua types yang diimpor tetap sama
...
// --- Komponen Pembantu: Kontrol Kuantitas ---
// Komponen ini menangani logic penambahan/pengurangan kuantitas untuk satu item (varian atau produk tanpa varian)
...
// --- Komponen Utama: ModalProductDetailDarkLight ---
const ModalProductDetailDarkLight: React.FC<DetailModalProps> = ({
    product,
    onClose,
    onOrder,
    color,
    ...
    // State untuk produk tanpa varian (kuantitas tunggal)
            ...
            orderVariants?.forEach(o => {
                ...
                if (qty > 0) {
                    const orderItem: OrderItem = {
                        ...
                        variantName: o.name || product.name,
                        finalPrice: product.price + o.priceAdjustment,
                        quantity: qty,
                    };
                    onOrder(orderItem);
                }
...
export default ModalProductDetailDarkLight;
...
import { Clock, Coffee, Heart, History, Package, ShoppingCart, Smartphone } from 'lucide-react'
...
const HeaderSix = ({ color, openDrawer, favoriteProducts, cart, history }: Props) => {
    return (
        <>
            <header className="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
                    <h1 className={`text-2xl font-black text-gray-900 flex items-center uppercase tracking-widest`}>
                        <Coffee className={`w-6 h-6 mr-2 ${color?.text600}`} />
                        Kedai Nusa
                    </h1>

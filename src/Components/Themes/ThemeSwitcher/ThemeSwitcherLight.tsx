...
export default function ThemeSwitcherLight({
    ...
    return (
        <section className="flex justify-end items-center space-x-3">
            ...
            {/* Tombol buka modal */}
            <button
                className="px-3 py-1 rounded-lg border text-sm shadow-sm hover:bg-gray-100"
            ...
            {open && (
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-gray-100 rounded-xl shadow-lg p-5 max-w-140 ">
                        ...
                        <div className="space-y-2 overflow-y-auto h-[80vh] no-scrollbar">
                            {listTheme?.map((t, i) => (
                                <div className="bg-gray-200 p-2 rounded-[8px]">
                                    ...
                                    <div className={`${opencategorie === t?.id ? 'flex items-center gap-4' : 'hidden'} mt-4`}>

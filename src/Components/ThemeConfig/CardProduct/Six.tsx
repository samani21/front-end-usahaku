...
const Six = ({ product, color, handleFav, onClick }: Props) => {
    return (
       <div
        ...
        <div className="flex-grow min-w-0">
            ...
            <div className="flex justify-between items-end mt-2 pt-2">
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <button className={`text-xs bg-gray-400 hover:bg-gray-600 px-4 py-2 rounded-full flex items-center shadow-lg transition duration-150`} onClick={() => handleFav(product?.id)}>

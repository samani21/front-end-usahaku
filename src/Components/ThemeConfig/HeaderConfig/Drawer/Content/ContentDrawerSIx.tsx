...
import { CheckCircle, Clock, Heart, ShoppingCart } from 'lucide-react';
...
const ContentDrawerSix = ({ type, favoriteProducts, cart, cartTotal, history, color }: Props) => {
    if (type === 'favorite') {
        return (
...
export default ContentDrawerSix
...
const HeroThree = ({ color, dataHero }: Props) => {
    return (
        <div className={`relative overflow-hidden rounded-xl m-4 shadow-lg bg-${color}-50`}> {/* Menggunakan warna tema terang */}
            <div className="p-6 md:p-10 flex flex-col md:flex-row items-center justify-between">
                <div className="text-center md:text-left mb-4 md:mb-0">
                    ...
                    <button className={`mt-4 inline-flex items-center px-4 py-2 bg-${color}-600 text-white font-semibold rounded-lg shadow-md hover:bg-${color}-700 transition`} onClick={() => {

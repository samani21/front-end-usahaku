...
const SideModal = ({ title, isOpen, onClose, primaryColor, children }: Props) => {
        ...
        <>
            ...
            >
                ...
                <div className="p-5 border-t border-gray-100 flex-shrink-0">
                    <button
                        className={`w-full py-3 text-white font-semibold rounded-xl transition duration-150 shadow-md ${bgColorClass} ${hoverBgClass} ${shadowClass}`}
                        onClick={onClose}
                    >
                        Lanjutkan Belanja
                    </button>

import { SidebarType, ThemeClasses } from '@/lib/Types/Theme/Three';
import { Heart, History, Package, ShoppingCart } from 'lucide-react';
import React from 'react'

const Header: React.FC<{ onSidebarToggle: (type: SidebarType) => void; themeClasses: ThemeClasses }> = ({ onSidebarToggle, themeClasses }) => (
        ...
        <div className="container mx-auto flex items-center justify-between p-4">
            ...
            <div className="flex space-x-4">
                <button
                    ...
                    onClick={() => onSidebarToggle('favorite')}

import { formatRupiah, Product, Theme } from '@/lib/Types/Theme/Elevent';
import { ChevronRight, Gift } from 'lucide-react';
import React from 'react'

const ProductCard: React.FC<{ product: Product; onClick: (product: Product) => void; theme: Theme }> = ({ product, onClick, theme }) => (
    <div
    ...
    >
        ...
        <div className="p-4">
            ...
            <button className={`mt-3 w-full flex items-center justify-center space-x-2 text-sm font-medium text-white ${theme.primaryBg} ${theme.primaryHover} rounded-lg py-2 transition-colors`}>
                <span>Pesan</span>

...
const HeroConfigPage = (props: Props) => {
    ...
    useEffect(() => {
        ...
        setAccentColor(heroMap[heroLayout || 0] ?? '')
    }, [heroLayout])
                ...
                <main className='space-y-4'>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                            ...
                            {
                                heroLayout === 4 && defaultImage ? <div className="flex items-center justify-between w-full my-4">
                                    <h3 className='text-gray-700'>Gunakan icon asli banner</h3>
                                        ...
                                        <div className="flex items-center justify-between w-full my-4">
                                            ...
                                            <div className="flex justify-around p-1 bg-gray-100 rounded-xl border border-gray-200">
                                                <button
                                                    onClick={() => {
                                                        setIsBanner(true)
                                                        setFrameBanner(frameBanner ? frameBanner : "Dark")
                                                    }
                                                    }

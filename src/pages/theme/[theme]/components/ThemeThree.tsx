...
import { useProductCatalog } from '@/hooks/Theme/ProductThree';
...
const ThemeThree = ({ themeName, listTheme, color, setThemeName }: Props) => {
    const {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <main className="container mx-auto p-4 pt-0">
                ...
                <HeroSection theme={3} color={colors} hero={hero} />

                {/* 4. Kategori Section */}
                {categorie?.length > 0 ? <Categorie color={colors} categorie={categorie} theme={3} setActiveCategory={setActiveCategory}

...
import { useProductCatalog } from '@/hooks/Theme/ProductSevent';
...
const ThemeSevent = ({ themeName, listTheme, color, setThemeName }: Props) => {
    const {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <HeroSection theme={7} color={colors} hero={hero} />

...
export const DUMMY_ORDERS = [
    { id: 1, productName: 'Biskuit Cokelat (Standar)', quantity: 1, price: 12500, variant: 'Reguler' },
    { id: 2, productName: 'Minyak Goreng Pouch 2L', quantity: 1, price: 35000, variant: 'Satu Porsi' },
    { id: 3, productName: 'Kopi Instan 3-in-1 (Box)', quantity: 2, price: 27000, variant: 'Satu Porsi' },
];
